 ...
 */
    ...
    /**
     * @Route("/components", name="home_components")
     */
    public function components(SettingRepository $settingRepository): Response
    {
        $setting=$settingRepository->findAll();
        return $this->render('home/components.html.twig', [
            'setting'=>$setting,

        ]);
    }
    /**
     * @Route("/portfolio", name="home_portfolio")
     */
    public function portfolio(SettingRepository $settingRepository): Response
    {
        $setting=$settingRepository->findAll();
